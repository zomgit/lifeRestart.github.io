...
class App {
  ...
  initPages() {
    ...
    talentPage.find("#random2").click(() => {
      talentPage.find("#random").hide();
      talentPage.find("#random2").hide();
      const ul = talentPage.find("#talents");
      this.#life.talentRandom2().forEach((talent) => {
        initTalent(talent, ul);
      });
    });
    ...
    trajectoryPage.find("#pass10Y").click(() => {
      for (let i = 0; i < 10; i++) {
        trajectory_next();
      }
    });

    trajectoryPage.find("#pass20Y").click(() => {
      for (let i = 0; i < 20; i++) {
        trajectory_next();
      }
    });
